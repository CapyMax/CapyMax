      ...
      <div className='mx-auto mt-[34px] w-[1280px] h-[584px] relative'>
        ...
        <div className='relative z-10'>
              ...
              <div className='absolute top-[59px] left-[170px] text-[12px]'>
                ...
                <div className='flex items-center gap-[4px]'>
                  ...
                  <div className='linear-bg px-[8px] py-[2px] rounded-full flex items-center justify-center text-white font-bold'>
                    <Image src="/points.svg" alt="point-boost-icon" className='w-[16px] h-[16px]' width={16} height={16} />
          ...
          <div className='absolute top-[164px] right-[32px] flex items-center justify-center gap-[24px]'>
            ...
            <a href="https://x.com/Capy_Max" className='w-[48px] h-[48px] bg-[#141414] hover:bg-[#765BFF] rounded-[12px] flex items-center justify-center'>
