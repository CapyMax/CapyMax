...
const oneData = {
  ...
  description: (
    <span>
      Income comes from traders&apos; profits and losses, as well as transaction
      fees, loan fees, etc. Ensure long-term sustainable compound interest.
    </span>
  ),
};
...
const twoData = {
  ...
  description: (
    <span>
      Use AI to accurately hedge all risk exposures of underlying assets, and
      stable returns can be obtained regardless of market bulls and bears.
    </span>
  ),
};
...
const threeData = {
  ...
  description: (
    <span>
      Maintain the original token returns while significantly increasing profits
      with extremely low liquidation risk.
    </span>
  ),
};
...
const fourData = {
  ...
  description: (
    <span>
      This risk control strategy monitors the market in real-time, adjusts
      leverage dynamically, and reserves a capital buffer to help users redeem
      assets and returns early during extreme volatility, preventing
      liquidation.
    </span>
  ),
};
...
function One(): JSX.Element {
  return (
    <div className="flex-[0_0_auto] relative">
      <Image
        src="/section-2-bg-1.svg"
        className="max-md:w-[192px] max-md:h-[305px]"
        alt="image-1"
        width={192}
        height={305}
      />
      <div className="absolute max-md:left-[24px] max-md:top-[88px] max-md:w-[144px]">
        <div className="max-md:text-[16px] max-md:leading-[1.4] max-md:mb-[8px]">
          {oneData.title.toUpperCase()}
        </div>
        <div className="max-md:text-[12px] max-md:leading-[1.6] max-md:opacity-40">
          {oneData.description}
        </div>
      </div>
    </div>
...
function Three(): JSX.Element {
  return (
    <div className="flex-[0_0_auto] relative">
      <Image
        src="/section-2-bg-3.svg"
        className="max-md:w-[192px] max-md:h-[267px]"
        alt="image-1"
        width={192}
        height={267}
      />
      <div className="absolute max-md:left-[24px] max-md:top-[96px] max-md:w-[144px]">
        <div className="max-md:text-[16px] max-md:leading-[1.4] max-md:mb-[8px]">
          {threeData.title.toUpperCase()}
        </div>
        <div className="max-md:text-[12px] max-md:leading-[1.6] max-md:opacity-40">
          {threeData.description}
        </div>
      </div>
    </div>
  );
...
function Four(): JSX.Element {
  return (
    <div className="flex-[0_0_auto] relative">
      <Image
        src="/section-2-bg-4.svg"
        className="max-md:w-[224px] max-md:h-[324px]"
        alt="image-1"
        width={224}
        height={324}
      />
...
function Badge(): JSX.Element {
  return (
    <RoundedButton className="absolute top-[48px] left-[80px] max-md:static">
      OUR VISION
    </RoundedButton>
  );
}
